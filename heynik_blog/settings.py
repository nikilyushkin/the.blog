...
ALLOWED_HOSTS = ["0.0.0.0", "127.0.0.1", "heynik.blog", "www.heynik.blog", "localhost"]
INTERNAL_IPS = ["127.0.0.1"]

ADMINS = [
    ("nikilyushkin", "me@nikilyushk.in"),
]
...
# STATICFILES_STORAGE was removed in Django 5.1 in favour of STORAGES
STORAGES = {
    "default": {
...
DEFAULT_FROM_EMAIL = "Nik from heynik.blog <behind@heynik.blog>"
...
APP_HOST = "heynik.blog"
MIRRORS = ["nikilyushk.in"]
